...
export const MOCK_BILLS: Bill[] = [
  {
    ...
    titleNepali: 'संघीय निजामती सेवा सुधार विधेयक, २०८२',
    ministry: 'Ministry of General Administration',
    status: 'committee',
    priority: 'high',
    dateIntroduced: '2026-03-15',
    dateLastAction: '2026-03-28',
    summary: 'Comprehensive reform of Nepal\'s federal civil service system introducing merit-based recruitment, performance evaluation, and removal of political appointments at senior levels. Key provision eliminates party cadre quotas in civil service promotions.',
    concerns: [
      'Merit-based criteria may disadvantage marginalized groups without adequate safeguards',
      'Transition period for existing civil servants unclear',
      'Appeals mechanism for wrongful removal not specified',
    ],
    affectedGroups: ['Civil servants', 'Marginalized communities', 'Political appointees'],
    sourceUrl: 'https://parliament.gov.np/en/bills/civil-service-2082',
    chamber: 'HOR',
    category: 'Governance Reform',
    postedReddit: false,
    postedTwitter: false,
    sponsor: 'balendra-shah',
  },
  {
    id: 'bill-2082-002',
    title: 'Digital Nepal Framework Act, 2082',
    titleNepali: 'डिजिटल नेपाल ढाँचा ऐन, २०८२',
    ministry: 'Ministry of Information and Communication Technology',
    status: 'floor_vote',
    priority: 'high',
    dateIntroduced: '2026-03-10',
    dateLastAction: '2026-03-29',
    summary: 'Establishes legal framework for Nepal\'s digital transformation including National Digital ID, faceless government services, mandatory digital payments above NPR 50,000, and data sovereignty protections. Enables 100% FDI in tech sector.',
    concerns: [
      'Data privacy provisions weaker than international standards',
      'Digital exclusion for rural populations without internet access',
      'Surveillance potential of National Digital ID raises civil liberty concerns',
    ],
    affectedGroups: ['All citizens', 'Tech sector', 'Rural communities', 'Small businesses'],
    sourceUrl: 'https://parliament.gov.np/en/bills/digital-nepal-2082',
    chamber: 'HOR',
  ...
  {
    id: 'bill-2082-003',
    title: 'Anti-Corruption Special Court Act, 2082',
    titleNepali: 'भ्रष्टाचार विरोधी विशेष अदालत ऐन, २०८२',
    ministry: 'Ministry of Law, Justice and Parliamentary Affairs',
    status: 'introduced',
    priority: 'high',
    dateIntroduced: '2026-03-20',
    dateLastAction: '2026-03-25',
    summary: 'Creates a dedicated fast-track Special Court for corruption cases with mandatory 6-month trial completion, asset freeze powers, and zero-bail provision for accused public officials with assets above NPR 50 million.',
    concerns: [
      'Zero-bail provision may violate presumption of innocence',
      'Court appointment mechanism lacks judicial independence safeguards',
      'Retroactive application clause is constitutionally questionable',
    ],
    affectedGroups: ['Public officials', 'Business community', 'Legal fraternity'],
    sourceUrl: 'https://parliament.gov.np/en/bills/anti-corruption-2082',
    chamber: 'HOR',
  ...
  {
    id: 'bill-2082-004',
    title: 'Investment Promotion and Protection Act, 2082',
    titleNepali: 'लगानी प्रवर्द्धन तथा संरक्षण ऐन, २०८२',
    ministry: 'Ministry of Industry, Commerce and Supplies',
    status: 'passed',
    priority: 'medium',
    dateIntroduced: '2026-03-05',
    dateLastAction: '2026-03-27',
    summary: 'Streamlines foreign investment approvals to 15 days, establishes One-Stop Investment Portal, provides tax holidays for strategic sectors, and creates an Investment Arbitration Tribunal for dispute resolution.',
    concerns: [
      'Arbitration panel lacks representation from civil society',
      'Tax holiday eligibility criteria favour large corporations',
    ],
    affectedGroups: ['Foreign investors', 'Domestic businesses', 'Labour unions'],
    sourceUrl: 'https://parliament.gov.np/en/bills/investment-2082',
    chamber: 'HOR',
  ...
  {
    id: 'bill-2082-005',
    title: 'Political Party Student Union Prohibition Bill, 2082',
    titleNepali: 'राजनीतिक दल विद्यार्थी संगठन निषेध विधेयक, २०८२',
    ministry: 'Ministry of Education, Science and Technology',
    status: 'committee',
    priority: 'high',
    dateIntroduced: '2026-03-18',
    dateLastAction: '2026-03-30',
    summary: 'Bans political party-affiliated student unions and trade unions from educational institutions and workplaces. Part of the 100-point governance roadmap. Penalties include party deregistration for violations.',
    concerns: [
      'Restricts freedom of association guaranteed by Constitution',
      'Independent student unions may face difficulties without party support',
      'Enforcement mechanism may be selectively applied',
      'Opposition parties view this as politically motivated',
    ],
    affectedGroups: ['Students', 'Youth organisations', 'Political parties', 'Labour unions'],
    sourceUrl: 'https://parliament.gov.np/en/bills/student-union-2082',
    chamber: 'HOR',
  ...
  {
    id: 'bill-2082-006',
    title: 'Forest and Biodiversity Conservation (Amendment) Bill, 2082',
    titleNepali: 'वन तथा जैविक विविधता संरक्षण (संशोधन) विधेयक, २०८२',
    ministry: 'Ministry of Forest and Environment',
    status: 'introduced',
    priority: 'medium',
    dateIntroduced: '2026-03-22',
    dateLastAction: '2026-03-26',
    summary: 'Strengthens penalties for illegal logging and wildlife trafficking. Introduces community forestry benefit-sharing formula and creates a Climate Resilience Fund with mandatory 2% budget allocation.',
    concerns: [
      'Community benefit-sharing formula needs consultation with indigenous communities',
      'Climate fund governance structure not defined',
    ],
    affectedGroups: ['Forest communities', 'Indigenous groups', 'Environmental NGOs'],
    sourceUrl: 'https://parliament.gov.np/en/bills/forest-2082',
    chamber: 'HOR',
  ...
  {
    id: 'bill-2082-007',
    title: 'National Health Insurance Expansion Bill, 2082',
    titleNepali: 'राष्ट्रिय स्वास्थ्य बीमा विस्तार विधेयक, २०८२',
    ministry: 'Ministry of Health and Population',
    status: 'passed',
    priority: 'low',
    dateIntroduced: '2026-03-08',
    dateLastAction: '2026-03-25',
    summary: 'Expands national health insurance coverage to all citizens with NPR 700,000 annual cap per family, adds 400+ procedures to coverage list, and reduces premium for below-poverty-line households to NPR 1,500/year.',
    concerns: [],
    affectedGroups: ['All citizens', 'Healthcare providers', 'Insurance sector'],
    sourceUrl: 'https://parliament.gov.np/en/bills/health-insurance-2082',
    chamber: 'HOR',
    category: 'Healthcare',
    postedReddit: true,
    postedTwitter: true,
  ...
  {
    id: 'bill-2082-008',
    title: 'Provincial Powers Delimitation Bill, 2082',
    titleNepali: 'प्रदेश अधिकार सीमांकन विधेयक, २०८२',
    ministry: 'Ministry of Law, Justice and Parliamentary Affairs',
    status: 'failed',
    priority: 'medium',
    dateIntroduced: '2026-03-12',
    dateLastAction: '2026-03-29',
    summary: 'Attempted to clarify constitutional boundaries between federal and provincial powers. Failed after provincial assemblies objected to reduced powers in taxation and infrastructure plans.',
    concerns: [
      'Centralises too much fiscal power at federal level',
      'Undermines spirit of federalism in Constitution',
    ],
    affectedGroups: ['Provincial governments', 'Local authorities', 'Citizens of all provinces'],
    sourceUrl: 'https://parliament.gov.np/en/bills/provincial-powers-2082',
    chamber: 'HOR',
    category: 'Federalism',
    postedReddit: false,
    postedTwitter: false,
